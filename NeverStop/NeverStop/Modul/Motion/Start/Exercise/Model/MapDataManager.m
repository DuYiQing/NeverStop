...
//    NSError *error = nil;
    ...
    [self.myQueue inDatabase:^(FMDatabase *db) {
        ...
        for (int i = 0; i < exerciseData.count; i++ ) {
            ...
            NSString *sqlChild = [NSString stringWithFormat:@"insert into AllLocationArray values (null, %f, %f, %d, %ld)", location.longitude, location.latitude, location.isStart, ID];
